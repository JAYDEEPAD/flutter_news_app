...
class NewsRepository {
  ...
  Future<CategoriesNewsModel> fetchNewsCategoires(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=4c466f8b88b749069f35d26b61c0c486';
  ...
  Future<NewsChannelsHeadlinesModel> fetchNewsChannelHeadlinesApi(String newsChannel) async {
    String newsUrl = 'https://newsapi.org/v2/top-headlines?sources=${newsChannel}&apiKey=4c466f8b88b749069f35d26b61c0c486';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
